...
typedef void(^MTKBlockGeneric)      (id self,                            id newVal);
typedef void(^MTKBlockChange)       (id self,                    id old, id newVal);
typedef void(^MTKBlockChangeMany)   (id self, NSString *keyPath, id old, id newVal);
typedef void(^MTKBlockInsert)       (id self,                            id newVal, NSIndexSet *indexes);
typedef void(^MTKBlockRemove)       (id self,                    id old,            NSIndexSet *indexes);
typedef void(^MTKBlockReplace)      (id self,                    id old, id newVal, NSIndexSet *indexes);

typedef void(^MTKBlockForeignChange)    (id self, id object,                      id old, id newVal);
typedef void(^MTKBlockForeignChangeMany)(id self, id object, NSString *keyPath,   id old, id newVal);
